...
public class TileEntityRenderBlackrockOre extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
        ...
        if(id >= 0 && id <= 3) {
            ...
            this.bindTexture(PTTReference.TEXTURE_BLACKROCK);
            ...
            this.bindTexture(PTTReference.TEXTURE_BLACKROCK_CRYSTAL);

...
public class TileEntityRenderEmeraldOre extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
        ...
        if(id >= 0 && id <= 3) {
            ...
            this.bindTexture(PTTReference.TEXTURE_EMERALD_SMALL);
            ...
            this.bindTexture(PTTReference.TEXTURE_EMERALD_CRYSTAL);
            ...
            GL11.glTranslated(x, y, z);
            m = tileEntity.blockMetadata;
            this.bindTexture(PTTReference.TEXTURE_EMERALD_BIG);
            GL11.glTranslatef(0.5F, 0.0F, 0.5F);
            GL11.glScalef(0.4F, 0.4F, 0.4F);
            if(m == 6) {
                GL11.glRotatef(-90.0F, 0.0F, 1.0F, 0.0F);

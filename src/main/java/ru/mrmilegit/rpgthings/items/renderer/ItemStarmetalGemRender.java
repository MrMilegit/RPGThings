...
public class ItemStarmetalGemRender implements IItemRenderer {
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object ... data) {
        if(type != ItemRenderType.EQUIPPED && type != ItemRenderType.EQUIPPED_FIRST_PERSON) {
            ...
            if(item.getItemDamage() == 0) {
                Minecraft.getMinecraft().renderEngine.bindTexture(PTTReference.TEXTURE_STARMETAL);
                PTTReference.MODEL_STARMETAL_SMALL.renderAll();
            } else {
                Minecraft.getMinecraft().renderEngine.bindTexture(PTTReference.TEXTURE_STARMETAL);

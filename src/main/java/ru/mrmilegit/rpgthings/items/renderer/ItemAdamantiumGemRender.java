...
public class ItemAdamantiumGemRender implements IItemRenderer {
   ...
   public void renderItem(ItemRenderType type, ItemStack item, Object ... data) {
      if(type != ItemRenderType.EQUIPPED && type != ItemRenderType.EQUIPPED_FIRST_PERSON) {
         ...
         if(item.getItemDamage() == 0) {
            Minecraft.getMinecraft().renderEngine.bindTexture(PTTReference.TEXTURE_ADAMANTIUM);
            PTTReference.MODEL_N2OBSIDIAN_SMALL.renderAll();
            Minecraft.getMinecraft().renderEngine.bindTexture(PTTReference.TEXTURE_ADAMANTIUM_CRYSTAL);

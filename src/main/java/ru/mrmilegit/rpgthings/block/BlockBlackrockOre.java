...
import ru.mrmilegit.rpgthings.tileentities.TileEntityBlackrockOre;
...
public class BlockBlackrockOre extends BlockContainer {

    public BlockBlackrockOre() {
        super(Material.rock);
        this.setHardness(2F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileEntityBlackrockOre();
    }

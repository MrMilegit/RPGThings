...
import ru.mrmilegit.rpgthings.tileentities.TileEntityPyriumOre;
...
public class BlockPyriumOre extends BlockContainer {

    public BlockPyriumOre() {
        super(Material.rock);
        this.setHardness(2F);
    ...
    public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
        return new TileEntityPyriumOre();
    }
